...
class SceneCreator(WebotsAPI):
    ...
    def create_scene(self):
        ...
        self.robotNode = self.create_robot("Ribbit", "DifferentialPlatform")
        
        translationCameraDevice = [0.0, 0.01, 0.25]
        ...
        translationLidarSensor = [0.0, 0.1, 0.25]
        rotationLidarSensor = [0, 1, 0, 3.1415]
        self.robotNode.addDevice("Lidar", "lidar", translationLidarSensor, rotationLidarSensor)
        #self.robotNode.addDevice("Range_finder", "rangefinder", translationLidarSensor, rotationLidarSensor)
        size = [0.3, 0.3, 0.3]
