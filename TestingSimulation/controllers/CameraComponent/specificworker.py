...
class SpecificWorker(GenericWorker):
    def __init__(self, proxy_map, startup_check=False):
        ...
        self.CameraRGBDSimple = "camera"
        self.WebotsManager.enableDevice(self.CameraRGBDSimple)
        if startup_check:
            self.startup_check()
        else:
    ...
    def compute(self):
        ...
        self.CameraRGBDSimple_getImage(self.WebotsManager.getDevice(self.CameraRGBDSimple))
        print('Got Image!')
        # computeCODE
        # try:
    ...
    def CameraRGBDSimple_getImage(self, camera):
        ...
        ret = self.WebotsManager.getImage(self.CameraRGBDSimple)
        return ret
    # ===================================================================
    # ===================================================================
